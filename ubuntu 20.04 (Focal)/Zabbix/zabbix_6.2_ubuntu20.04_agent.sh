...
#
#
# Execute command:    wget "https://github.com/CreaMate-Consulting/bash-scripts-for-ubuntu/raw/main/ubuntu20.04/Zabbix/zabbix_6.2_ubuntu20.04_agent.sh" && bash zabbix_6.2_ubuntu20.04_agent.sh
